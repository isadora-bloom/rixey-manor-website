...
const SLOT_CONFIG = {
  ...
  'history-construction':      { label: 'Building the front (1928)',             aspect: '3/2',  group: 'History' },
  'history-margaret-wedding':  { label: 'Dyer wedding on the steps (1928)',      aspect: '4/3',  group: 'History' },
  'history-anniversary':       { label: '50th anniversary, 1978 (same steps)',   aspect: '4/3',  group: 'History' },
